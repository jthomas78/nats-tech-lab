...
// Pending test for Phase 47a (BUSINESS_RULES-REFDATA.md's BR-D45, pointing
...
// so `go test ./...` stays green until Phase 47a lands.

import "testing"

func TestKVCachePublishesObsPubsubEnvelopeAlongsideEvtPublish(t *testing.T) {
	t.Skip("pending Phase 47a implementation — see BR-D45/BR-045: " +
