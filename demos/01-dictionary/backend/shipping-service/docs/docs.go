    ...
    "paths": {
        ...
        "/api/kv/buckets/{bucket}/watch": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "KV bucket name (e.g. dict-a-acme, refdata-acme)",
                        "name": "bucket",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/rpc-watch": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "SSE stream — data: {obs.rpc.* JSON}",
                        "schema": {
                            "type": "string"
                        }
                    },
