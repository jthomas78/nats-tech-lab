        ...
        "/api/refdata-demo/{context}/{type}/{code}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "company/business-unit context (e.g. acme)",
                        "name": "context",
                        "in": "path",
                        "required": true
                    },
