module github.com/jthomas78/nats-tech-lab/demos/01-dictionary/backend/shipping-service
...
replace github.com/jthomas78/nats-tech-lab/shared/jstream => ../../../../shared/jstream
