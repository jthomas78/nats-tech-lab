// Package natstrace is pricing-service's Phase 28b copy of
// trading-partner-service's hand-rolled distributed tracing prototype
// (BR-036/BR-037/BR-P25) — no go.opentelemetry.io/* dependency,
// W3C-compatible on the wire, OTLP-shaped in its fields. It is deliberately
// duplicated per service (not a shared module), the same way
...
// "pricing-service", but its subjects use the short form "pricing" —
// deriving from the subject avoids that mismatch).
type Tracer struct {
	nc *nats.Conn
}
