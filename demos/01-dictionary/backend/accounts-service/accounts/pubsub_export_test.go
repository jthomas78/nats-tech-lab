...
// Pending tests for Phase 47a (BUSINESS_RULES-ACCOUNTS.md's BR-AC34): a
...
// `go test ./...` stays green until Phase 47a lands.

import "testing"

func TestTenantExportsIncludesObsPubsubStreamExport(t *testing.T) {
	t.Skip("pending Phase 47a implementation — see BR-AC34: tenantExports() " +
...
func TestAddPlatformPubsubImportMirrorsAddPlatformTraceImport(t *testing.T) {
	t.Skip("pending Phase 47a implementation — see BR-AC34: a new " +
