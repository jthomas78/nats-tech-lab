...
const (
	ShellReadSubject  = "api._platform.registry.frontend-plugins.read.v1"
	CuratedSubject    = "api._platform.registry.entries.curated.v1"
	UpsertSubject     = "api._platform.registry.entries.upsert.v1"
	SetEnabledSubject = "api._platform.registry.entries.set-enabled.v1"
	AuditSubject      = "api._platform.registry.audit.list.v1"
)
