...
func (r *ContainerRepository) Upsert(ctx context.Context, state domain.ContainerState) (domain.ContainerState, error) {
	_, err := r.db.ExecContext(ctx, `
		INSERT INTO containers (context, container_id, cargo, origin_port, dest_port, status, terminal_port, on_ship_id, updated_at)
		VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
		ON CONFLICT (context, container_id) DO UPDATE
		...
		state.Context, state.ContainerID, state.Cargo, state.OriginPort, state.DestPort,
