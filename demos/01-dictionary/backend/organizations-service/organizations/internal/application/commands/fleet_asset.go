...
func NewFleetAssetHandler(partners domain.OrganizationRepository, fleet domain.FleetAssetRepository, validator domain.VehicleTypeValidator) *FleetAssetHandler {
