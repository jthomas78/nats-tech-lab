...
// Confirmed 2026-08-13 (BUSINESS_RULES-TRADING-PARTNER.md BR-TP07): shared
...
async function load() {
  ...
  try {
    ...
    // server-side.
    partners.value = (res.tradingPartners ?? []).filter((tp) => tp.type === props.partnerType)
  } catch (e) {
...
<template>
  <div class="lab-panel trading-partners-panel">
