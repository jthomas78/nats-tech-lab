...
const iconCells = {
  ...
  "docker-compose-network": [
    ...
    ["net-ship-svc", "1", "ico-container", 848, 333],
    ["net-refdata-svc", "1", "ico-container", 848, 543],
    ["net-accounts-svc", "1", "ico-container", 848, 753],
    ["net-nats", "1", "ico-nats", 1243, 338],
    ["net-nats-data", "1", "ico-volume", 1243, 458],
    ["net-postgres", "1", "ico-db", 1243, 548],
    ["net-pg-data", "1", "ico-volume", 1243, 638],
    ["net-refdata-pg", "1", "ico-db", 1243, 708],
    ["net-refdata-pg-data", "1", "ico-volume", 1243, 798],
    ["net-accounts-pg", "1", "ico-db", 1243, 868],
    ["net-accounts-pg-data", "1", "ico-volume", 1243, 958],
  ],
