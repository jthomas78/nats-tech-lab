...
var uiCopySeed = []seedItem{
	...
	{"nav.fleetManagement", "Fleet Management", "Gestión de flota"},
	{"nav.portManagement", "Port Management", "Gestión portuaria"},
	{"nav.viewSelector", "View", "Vista"},
	{"select.none", "—", "—"},
	{"app.title", "Ship Management", "Gestión de buques"},
	{"app.subtitleFleet", "fleet overview · docked ships · manifests", "visión general de la flota · buques atracados · manifiestos"},
	{"app.subtitlePort", "terminal yard · ships at port · container operations", "patio de terminal · buques en puerto · operaciones de contenedores"},
