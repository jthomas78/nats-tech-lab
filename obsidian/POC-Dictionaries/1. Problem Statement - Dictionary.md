...
There must also be a demo-able application (it does not need to be a logistics application) so the approach can be showcased and the implementation reviewed in code.
