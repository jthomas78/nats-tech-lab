Findings write-up for Phase 11 — Dictionary as a Service, closing out the investigation started in [[1. Problem Statement - Dictionary]]. Implementation detail lives in the repo (`ARCHITECTURE.md` § "Reference Data Service", `BUSINESS_RULES.md` § "Reference Data Service"); this note is the stakeholder-facing *why* and *what we learned*.
