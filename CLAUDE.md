...
All ADRs, lab and V3 scope, live in this one folder as
`ADR-<nnn>-<scope>-<context>-<slug>.md` with a YAML front matter block. Read
`obsidian/V3-Platform/Architecture/ADR/README.md` before creating or renaming
one. Numbers are global and never renumbered; `ADR-INDEX.md` and the card PDF
