...
- **Shared identity, separate vetting aggregate** ([ADR-046](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-046-lab-organizations-transporter-aggregate-split.md),
...
- **Temporal/saga design reviewed in [ADR-047](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-047-lab-organizations-transporter-vetting-temporal-saga.md)
...
- **Documents**: NATS Object Store (tenant-scoped bucket, same
  ...
  Reviewed in [ADR-048](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-048-lab-organizations-document-storage-nats-object-store.md),
...
- **Concurrency now needs two mechanisms**, a direct consequence of the
  ...
  [ADR-049](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-049-lab-organizations-cross-aggregate-concurrency.md),
...
- [x] **38a** — DONE 2026-08-20 (BR-TP18–BR-TP20). `TransporterProfile`
      ...
      [ADR-046](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-046-lab-organizations-transporter-aggregate-split.md),
...
- [x] **38b** — DONE 2026-08-21 (BR-TP21–BR-TP28). Was reopened 2026-08-21
      ...
      **Must satisfy [ADR-047](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-047-lab-organizations-transporter-vetting-temporal-saga.md)'s
...
- [x] **38c-ii** — DONE 2026-08-20 (BR-TP40–BR-TP45). NATS Object Store
      ...
      [ADR-048](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-048-lab-organizations-document-storage-nats-object-store.md)'s
...
> **Provenance decision:** [ADR-050](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-050-lab-organizations-git-certificate-change-log-provenance.md)
...
> decision with its own ADR ([ADR-051](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-051-lab-organizations-ulid-entity-identity.md)),
...
Full argument in
[ADR-051](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-051-lab-organizations-ulid-entity-identity.md).
...
### Phase 51 — IMPLEMENTED (2026-08-27) — Credential Revocation and Connection Outcome
...
### Phase 52 — IMPLEMENTED (2026-08-27) — Reaping Expired Sessions from the User Registry
...
> Design record:
> [ADR-052](../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-052-lab-data-one-postgres-instance-database-per-service.md).
...
- [x] `grep -rln "Phase 46"` outside this document — four hits, all design
      ...
      `../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-046-lab-organizations-transporter-aggregate-split.md`,
      `../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-047-lab-organizations-transporter-vetting-temporal-saga.md`,
      `../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-048-lab-organizations-document-storage-nats-object-store.md`,
      `../../obsidian/V3-Platform/Architecture/ADR/lab/ADR-049-lab-organizations-cross-aggregate-concurrency.md`) — updated to "Phase 38" in
