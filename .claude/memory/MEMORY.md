...
- [compose_split_aws_deployment_decision](compose_split_aws_deployment_decision.md) — DECIDED 2026-09-07/08, not implemented: 3 compose files x 3 projects, prove multi-region locally before AWS, Compose local + Helm/EKS production; AWS work list
