...
**How to apply:** Phase 13 (`.claude/plans/Main-POC-Plan.md`, formerly Phase 18) was the static-server-config-accounts spike this note originally anticipated — it completed 2026-07-27. The actual hard-isolation tenant-management service is now Phase 14 (`accounts-service`, formerly tracked as Phase 20), plan-approved 2026-07-28 and not yet implemented — build it as its own service/bounded context per this decision, wiring it to `refdata-service` only in the admin frontend, not in shared backend code. This is a discussion-stage agreement, not yet captured as a formal DD in the System Design doc — do that when the user is ready to record it.
