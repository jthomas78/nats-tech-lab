...
| L4-01-024 | Included | JetStream domain overlay: storage identity. T3 and T4 as drawn use one domain across the supercluster. T5 uses one domain per cluster, named `za`, `au` and `hub` in demo 03. | Sheet 1 overlay C, sheet 2 |
